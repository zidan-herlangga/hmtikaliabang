...
@section('title', 'Header Menu Settings')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark font-weight-bold">Header Menu</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card shadow-sm">
                        <div class="card-header">
                            <h3 class="card-title">Manage Navigation Links</h3>
                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <small class="text-muted d-block">
                                                    ...
                                                    Drag items to reorder or nest them. Nesting creates dropdown menus.
                                                </small>
                                            </div>
                                        </div>
...
@push('scripts')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // maxLevel: 1 allows 1 level of nesting (Parent -> Child)
            // Change to 2 or more if you need deeper dropdowns
