    ...
    <div class="space-y-6">
        ...
        @empty
            <div class="text-center py-16 bg-dark-800/20 rounded-2xl border border-white/10">
                <span class="iconify text-6xl text-white/20 mb-4" data-icon="mdi:file-search-outline"></span>
                <h3 class="text-xl font-semibold text-white mb-2">Tidak Ada Hasil</h3>
                <p class="text-white/60">Maaf, tidak ada postingan yang cocok dengan pencarian Anda.</p>
            </div>
        @endforelse
